...
//Affichage des forums
    ...
    if (!empty($data['forum_post']))
    {
	 ...
	 $page = ceil($nbr_post / $nombreDeMessagesParPage);
         ...
         <img src="./images/aller.png" alt="go" width="150" height="50"/></a></td></tr>';
...
echo '</table></div>';
//Le pied de page ici :
echo'<div id="footer" style="width=1025px">
<h2>
Qui est en ligne ?
</h2>
';
...
echo'QLA - Que les Animes, copyright.';
$query->CloseCursor();
