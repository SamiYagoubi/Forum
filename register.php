...
if (empty($_POST['pseudo'])) // Si on la variable est vide, on peut considérer qu'on est sur la page de formulaire
{
    ...
    <label for="email">* Votre Mail :</label><input type="text" name="email" id="email" /><br />
    <br>
	...
	<label for="localisation">Adresse :</label><input type="text" name="localisation" id="localisation" />
	</fieldset>
